FINAL_WISH_TABLE_TIER_2 = {
  ...
  },
  {
    ...
    Items = {
      ...
      { Item = "food_apple_big", Amount = 1, Weight = 20 },
      { Item = "food_apple_huge", Amount = 1, Weight = 25 },
      { Item = "food_apple_perfect", Amount = 1, Weight = 5 },
      { Item = "food_apple_golden", Amount = 1, Weight = 3 },
      { Item = "food_banana", Amount = 1, Weight = 10 },
      { Item = "food_banana_big", Amount = 1, Weight = 5 },
      { Item = "food_banana_golden", Amount = 1, Weight = 2 }
    },
  },
  {
    Category = "Utility",
  ...
  },
  {
    ...
    Max = 15,
    AlwaysSpawn = { 
      "seed_golden", "seed_golden", "seed_joy", 
      "seed_joy", "gummi_wonder", "gummi_wonder",
      "boost_calcium", "boost_carbos", "boost_hp_up", "boost_iron",
      "boost_nectar", "boost_zinc",
    },
		Guaranteed = { 
      { 
				{ Item = "loot_heart_scale", Amount = 6, Weight = 1 },
			},
			{
	...
	},
  {
    ...
    Category = "Recruitment",
      ...
      { Item = "medicine_amber_tear", Amount = 2, Weight = 3 },
