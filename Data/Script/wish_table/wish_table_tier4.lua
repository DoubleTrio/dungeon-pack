FINAL_WISH_TABLE_TIER_4 = {
  {
    ...
    Items = {
      { Item = "money", Amount = 600, Weight = 25 },
      { Item = "money", Amount = 700, Weight = 20 },
  ...
  },
  {
    ...
    Items = {
      ...
      { Item = "berry_enigma", Amount = 1, Weight = 5 },
			{ Item = "berry_micle", Amount = 1, Weight = 5 },
      { Item = "berry_rowap", Amount = 1, Weight = 5 },
      { Item = "food_apple", Amount = 1, Weight = 8 },
      { Item = "food_apple_big", Amount = 1, Weight = 10 },
      { Item = "food_apple_huge", Amount = 1, Weight = 20 },
      { Item = "food_apple_perfect", Amount = 1, Weight = 20 },
      { Item = "food_apple_golden", Amount = 1, Weight = 13 },
      { Item = "food_banana", Amount = 1, Weight = 10 },
      { Item = "food_banana_big", Amount = 1, Weight = 15 },
      { Item = "food_banana_golden", Amount = 1, Weight = 7 }
    },
  },
  {
    Category = "Utility",
    ...
    Items = {
      ...
      { Item = "seed_ban", Amount = 1, Weight = 10 },
      { Item = "seed_joy", Amount = 1, Weight = 10 },
  ...
  },
  {
    ...
    Max = 23,
    AlwaysSpawn = { 
      "seed_golden", "seed_golden", "seed_golden", "seed_joy", 
      "seed_joy", "gummi_wonder", "gummi_wonder", "gummi_wonder",
      ...
      { 
				{ Item = "loot_heart_scale", Amount = 5, Weight = 1 },
			},
		},
    Items = {
      ...
      { Item = "tm_drain_punch", Amount = 1, Weight = 5 },
