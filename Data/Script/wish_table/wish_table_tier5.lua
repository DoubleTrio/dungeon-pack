FINAL_WISH_TABLE_TIER_5 = {
  {
    ...
    Items = {
      { Item = "money", Amount = 700, Weight = 40 },
      { Item = "money", Amount = 800, Weight = 20 },
      { Item = "money", Amount = 900, Weight = 20 },
      { Item = "money", Amount = 1000, Weight = 20 },
      { Item = "loot_pearl", Amount = 5, Weight = 9 },
      { Item = "loot_pearl", Amount = 6, Weight = 8 },
      { Item = "loot_pearl", Amount = 7, Weight = 7 },
      { Item = "loot_pearl", Amount = 8, Weight = 6 },
      { Item = "loot_pearl", Amount = 9, Weight = 5 },
      { Item = "money", Amount = 700, Weight = 40 },
      { Item = "loot_nugget", Amount = 1, Weight = 20 },
    },
  },
  {
    Category = "Food",
    ...
    Max = 36,
		Guaranteed = {
			{
				{ Item = "food_apple_golden", Amount = 1, Weight = 10 }
			},
      {
				{ Item = "food_banana_golden", Amount = 1, Weight = 10 }
			},
      {
        { Item = "berry_lum", Amount = 1, Weight = 3 },
      },
      {
        { Item = "berry_leppa", Amount = 1, Weight = 5 },
      },
      {
        { Item = "berry_apicot", Amount = 1, Weight = 5 },
      },
      {
        { Item = "berry_jaboca", Amount = 1, Weight = 5 },
      },
      {
        { Item = "berry_liechi", Amount = 1, Weight = 5 },
      },
      {
        { Item = "berry_starf", Amount = 1, Weight = 5 },
      },
      {
        { Item = "berry_salac", Amount = 1, Weight = 5 },
      },
      {
        { Item = "berry_ganlon", Amount = 1, Weight = 5 },
      },
      {
        { Item = "berry_enigma", Amount = 1, Weight = 5 },
      },
      {
        { Item = "berry_micle", Amount = 1, Weight = 5 },
      },
      {
        { Item = "berry_sitrus", Amount = 1, Weight = 3 },
        { Item = "berry_oran", Amount = 1, Weight = 3 },
      },
      {
    ...
    Items = {
      ...
      { Item = "berry_liechi", Amount = 1, Weight = 5 },
      { Item = "berry_starf", Amount = 1, Weight = 5 },
      { Item = "berry_petaya", Amount = 1, Weight = 5 },
      { Item = "berry_salac", Amount = 1, Weight = 5 },
      { Item = "berry_ganlon", Amount = 1, Weight = 5 },
      { Item = "berry_enigma", Amount = 1, Weight = 5 },
			{ Item = "berry_micle", Amount = 1, Weight = 5 },
      { Item = "food_apple", Amount = 1, Weight = 8 },
      { Item = "food_apple_big", Amount = 1, Weight = 8 },
      { Item = "food_apple_huge", Amount = 1, Weight = 18 },
      { Item = "food_apple_perfect", Amount = 1, Weight = 25 },
      { Item = "food_apple_golden", Amount = 1, Weight = 15 },
      { Item = "food_banana", Amount = 1, Weight = 10 },
      { Item = "food_banana_big", Amount = 1, Weight = 13 },
      { Item = "food_banana_golden", Amount = 1, Weight = 10 }
    },
  },
  {
    ...
    Max = 13,
		Guaranteed = { 
			{ 
				{ Item = "orb_revival", Amount = 1, Weight = 10 },
			},
      { 
				{ Item = "orb_revival", Amount = 1, Weight = 10 },
			},
      ...
      { 
				{ Item = "orb_invert", Amount = 1, Weight = 10 },
			},
      { 
      ...
      {
        { Item = "medicine_amber_tear", Amount = 3, Weight = 1 },
      },
      {
      ...
      {
        { Item = "ammo_golden_thorn", Amount = 9, Weight = 3 },
      },
      {
        { Item = "ammo_golden_thorn", Amount = 9, Weight = 3 },
      },
      ...
      {
        { Item = "ammo_cacnea_spike", Amount = 9, Weight = 3 },
        { Item = "ammo_corsola_twig", Amount = 9, Weight = 3 },
        { Item = "ammo_geo_pebble", Amount = 9, Weight = 3 },
        { Item = "ammo_golden_thorn", Amount = 9, Weight = 3 },
        { Item = "ammo_gravelerock", Amount = 9, Weight = 3 },
        { Item = "ammo_iron_thorn", Amount = 9, Weight = 3 },
        { Item = "ammo_rare_fossil", Amount = 9, Weight = 3 },
        { Item = "ammo_silver_spike", Amount = 9, Weight = 3 },
        { Item = "ammo_stick", Amount = 9, Weight = 3 },
        { Item = "ammo_iron_thorn", Amount = 9, Weight = 3 },
      },
      {
        { Item = "seed_golden", Amount = 1, Weight = 10 },
      },
      {
        { Item = "seed_golden", Amount = 1, Weight = 10 },
      }
    ...
    Items = {
			{ Item = "berry_leppa", Amount = 1, Weight = 3 },
      ...
      { Item = "ammo_corsola_twig", Amount = 9, Weight = 3 },
      { Item = "ammo_geo_pebble", Amount = 9, Weight = 3 },
      { Item = "ammo_golden_thorn", Amount = 9, Weight = 8 },
      { Item = "ammo_gravelerock", Amount = 9, Weight = 3 },
      { Item = "ammo_iron_thorn", Amount = 9, Weight = 3 },
      { Item = "ammo_rare_fossil", Amount = 9, Weight = 3 },
      { Item = "ammo_silver_spike", Amount = 9, Weight = 3 },
  ...
  },
  {
    ...
    Max = 18,
    AlwaysSpawn = { 
      "seed_golden", "seed_golden", "seed_golden",
      "seed_golden", "seed_golden",
      "gummi_wonder", "gummi_wonder", "gummi_wonder", "gummi_wonder", 
      "gummi_wonder", "gummi_wonder", "gummi_wonder", "gummi_wonder",
      "boost_calcium", "boost_carbos", "boost_hp_up", "boost_iron",
      "boost_nectar", "boost_zinc", "boost_calcium", "boost_carbos", 
      "boost_hp_up", "boost_iron", "boost_nectar", "boost_zinc", 
      "boost_calcium", "machine_recall_box"
    },
		Guaranteed = { 
      { 
				{ Item = "loot_heart_scale", Amount = 9, Weight = 1 },
			},
      { 
				{ Item = "loot_heart_scale", Amount = 9, Weight = 1 },
			},
      {
        { Item = "tm_earthquake", Amount = 1, Weight = 5 },
        { Item = "tm_fire_blast", Amount = 1, Weight = 5 },
        { Item = "tm_giga_drain", Amount = 1, Weight = 5 },
        { Item = "tm_fire_blast", Amount = 1, Weight = 5 },
        { Item = "tm_fly", Amount = 1, Weight = 5 },
        { Item = "tm_dive", Amount = 1, Weight = 5 },
        { Item = "tm_dig", Amount = 1, Weight = 5 },
        { Item = "tm_focus_blast", Amount = 1, Weight = 5 },
        { Item = "tm_rock_climb", Amount = 1, Weight = 5 },
        { Item = "tm_sludge_wave", Amount = 1, Weight = 5 },
        { Item = "tm_waterfall", Amount = 1, Weight = 5 },
        { Item = "tm_stone_edge", Amount = 1, Weight = 5 },
        { Item = "tm_overheat", Amount = 1, Weight = 5 },
        { Item = "tm_rock_climb", Amount = 1, Weight = 5 },
      },
      {
        { Item = "tm_earthquake", Amount = 1, Weight = 5 },
      ...
      },
      {
        ...
        { Item = "tm_overheat", Amount = 1, Weight = 5 },
        { Item = "tm_rock_climb", Amount = 1, Weight = 5 },
        { Item = "tm_acrobatics", Amount = 1, Weight = 5 },
      },
      {
        { Item = "tm_earthquake", Amount = 1, Weight = 5 },
        { Item = "tm_fire_blast", Amount = 1, Weight = 5 },
    ...
    Items = {
      ...
      { Item = "seed_joy", Amount = 1, Weight = 12 },
      ...
      { Item = "tm_acrobatics", Amount = 1, Weight = 3 },
      { Item = "tm_aerial_ace", Amount = 1, Weight = 3 },
      { Item = "tm_attract", Amount = 1, Weight = 1 },
      { Item = "tm_avalanche", Amount = 1, Weight = 3 },
      { Item = "tm_blizzard", Amount = 1, Weight = 3 },
      { Item = "tm_brick_break", Amount = 1, Weight = 2 },
      { Item = "tm_brine", Amount = 1, Weight = 1 },
      { Item = "tm_bulk_up", Amount = 1, Weight = 1 },
      { Item = "tm_bulldoze", Amount = 1, Weight = 3 },
      ...
      { Item = "tm_dark_pulse", Amount = 1, Weight = 3 },
      { Item = "tm_dazzling_gleam", Amount = 1, Weight = 2 },
      { Item = "tm_defog", Amount = 1, Weight = 1 },
      { Item = "tm_dig", Amount = 1, Weight = 5 },
      { Item = "tm_dive", Amount = 1, Weight = 5 },
      { Item = "tm_double_team", Amount = 1, Weight = 1 },
      { Item = "tm_dragon_claw", Amount = 1, Weight = 3 },
      { Item = "tm_dragon_pulse", Amount = 1, Weight = 3 },
      { Item = "tm_dragon_tail", Amount = 1, Weight = 3 },
      { Item = "tm_drain_punch", Amount = 1, Weight = 3 },
      { Item = "tm_dream_eater", Amount = 1, Weight = 3 },
      { Item = "tm_earthquake", Amount = 1, Weight = 5 },
      { Item = "tm_echoed_voice", Amount = 1, Weight = 3 },
      { Item = "tm_embargo", Amount = 1, Weight = 1 },
      { Item = "tm_endure", Amount = 1, Weight = 1 },
      { Item = "tm_energy_ball", Amount = 1, Weight = 3 },
      { Item = "tm_explosion", Amount = 1, Weight = 1 },
      { Item = "tm_facade", Amount = 1, Weight = 3 },
      { Item = "tm_false_swipe", Amount = 1, Weight = 1 },
      { Item = "tm_fire_blast", Amount = 1, Weight = 5 },
      { Item = "tm_flame_charge", Amount = 1, Weight = 3 },
      { Item = "tm_flamethrower", Amount = 1, Weight = 3 },
      { Item = "tm_flash", Amount = 1, Weight = 1 },
      { Item = "tm_flash_cannon", Amount = 1, Weight = 3 },
      { Item = "tm_fling", Amount = 1, Weight = 1 },
      { Item = "tm_fly", Amount = 1, Weight = 5 },
      { Item = "tm_focus_blast", Amount = 1, Weight = 3 },
      { Item = "tm_focus_punch", Amount = 1, Weight = 3 },
      { Item = "tm_frost_breath", Amount = 1, Weight = 3 },
      { Item = "tm_frustration", Amount = 1, Weight = 4 },
      { Item = "tm_giga_drain", Amount = 1, Weight = 4 },
      { Item = "tm_giga_impact", Amount = 1, Weight = 4 },
      { Item = "tm_grass_knot", Amount = 1, Weight = 3 },
      { Item = "tm_gyro_ball", Amount = 1, Weight = 3 },
      ...
      { Item = "tm_ice_beam", Amount = 1, Weight = 3 },
      { Item = "tm_incinerate", Amount = 1, Weight = 1 },
      { Item = "tm_infestation", Amount = 1, Weight = 1 },
      { Item = "tm_iron_tail", Amount = 1, Weight = 3 },
      { Item = "tm_light_screen", Amount = 1, Weight = 1 },
      { Item = "tm_low_sweep", Amount = 1, Weight = 3 },
      { Item = "tm_natural_gift", Amount = 1, Weight = 1 },
      { Item = "tm_nature_power", Amount = 1, Weight = 1 },
      { Item = "tm_overheat", Amount = 1, Weight = 4 },
      { Item = "tm_payback", Amount = 1, Weight = 1 },
      { Item = "tm_pluck", Amount = 1, Weight = 3 },
      { Item = "tm_poison_jab", Amount = 1, Weight = 3 },
      { Item = "tm_power_up_punch", Amount = 1, Weight = 3 },
      { Item = "tm_protect", Amount = 1, Weight = 1 },
      { Item = "tm_psych_up", Amount = 1, Weight = 3 },
      { Item = "tm_psychic", Amount = 1, Weight = 1 },
      { Item = "tm_psyshock", Amount = 1, Weight = 3 },
      ...
      { Item = "tm_retaliate", Amount = 1, Weight = 3 },
      { Item = "tm_return", Amount = 1, Weight = 3 },
      { Item = "tm_roar", Amount = 1, Weight = 1 },
      { Item = "tm_rock_climb", Amount = 1, Weight = 4 },
      { Item = "tm_rock_polish", Amount = 1, Weight = 1 },
      { Item = "tm_rock_slide", Amount = 1, Weight = 4 },
      { Item = "tm_rock_smash", Amount = 1, Weight = 1 },
      { Item = "tm_rock_tomb", Amount = 1, Weight = 3 },
      ...
      { Item = "tm_scald", Amount = 1, Weight = 3 },
      { Item = "tm_secret_power", Amount = 1, Weight = 1 },
      { Item = "tm_shadow_ball", Amount = 1, Weight = 3 },
      { Item = "tm_shadow_claw", Amount = 1, Weight = 3 },
      { Item = "tm_shock_wave", Amount = 1, Weight = 3 },
      { Item = "tm_silver_wind", Amount = 1, Weight = 3 },
      { Item = "tm_sky_drop", Amount = 1, Weight = 3 },
      { Item = "tm_sludge_bomb", Amount = 1, Weight = 3 },
      { Item = "tm_sludge_wave", Amount = 1, Weight = 3 },
      { Item = "tm_smack_down", Amount = 1, Weight = 3 },
      { Item = "tm_snarl", Amount = 1, Weight = 1 },
      { Item = "tm_snatch", Amount = 1, Weight = 1 },
      { Item = "tm_steel_wing", Amount = 1, Weight = 3 },
      { Item = "tm_stone_edge", Amount = 1, Weight = 3 },
      ...
      { Item = "tm_surf", Amount = 1, Weight = 3 },
      { Item = "tm_swagger", Amount = 1, Weight = 1 },
      { Item = "tm_swords_dance", Amount = 1, Weight = 3 },
      { Item = "tm_taunt", Amount = 1, Weight = 1 },
      { Item = "tm_telekinesis", Amount = 1, Weight = 1 },
      { Item = "tm_thief", Amount = 1, Weight = 1 },
      { Item = "tm_thunder", Amount = 1, Weight = 5 },
      { Item = "tm_thunder_wave", Amount = 1, Weight = 1 },
      { Item = "tm_thunderbolt", Amount = 1, Weight = 3 },
      { Item = "tm_torment", Amount = 1, Weight = 1 },
      { Item = "tm_u_turn", Amount = 1, Weight = 1 },
      { Item = "tm_venoshock", Amount = 1, Weight = 2 },
      { Item = "tm_volt_switch", Amount = 1, Weight = 3 },
      { Item = "tm_water_pulse", Amount = 1, Weight = 3 },
      { Item = "tm_waterfall", Amount = 1, Weight = 3 },
      { Item = "tm_whirlpool", Amount = 1, Weight = 3 },
      { Item = "tm_wild_charge", Amount = 1, Weight = 3 },
      { Item = "tm_will_o_wisp", Amount = 1, Weight = 1 },
      { Item = "tm_work_up", Amount = 1, Weight = 3 },
      { Item = "tm_x_scissor", Amount = 1, Weight = 3 },
    },
  },
	{
    Category = "Equipment",
      ...
      {
        { Item = "held_golden_mask", Amount = 1, Weight = 2 },
      }
    },
		Items = {
      ...
      { Item = "held_zinc_band", Amount = 1, Weight = 2 },
			{ Item = "held_blank_plate", Amount = 1, Weight = 2},
			{ Item = "held_draco_plate", Amount = 1, Weight = 2},
			{ Item = "held_dread_plate", Amount = 1, Weight = 2},
			{ Item = "held_earth_plate", Amount = 1, Weight = 2},
			{ Item = "held_fist_plate", Amount = 1, Weight = 2},
			{ Item = "held_flame_plate", Amount = 1, Weight = 2},
			{ Item = "held_icicle_plate", Amount = 1, Weight = 2},
			{ Item = "held_insect_plate", Amount = 1, Weight = 2},
			{ Item = "held_iron_plate", Amount = 1, Weight = 2},
			{ Item = "held_meadow_plate", Amount = 1, Weight = 2},
			{ Item = "held_mind_plate", Amount = 1, Weight = 2},
			{ Item = "held_pixie_plate", Amount = 1, Weight = 2},
			{ Item = "held_sky_plate", Amount = 1, Weight = 2},
			{ Item = "held_splash_plate", Amount = 1, Weight = 2},
			{ Item = "held_spooky_plate", Amount = 1, Weight = 2},
			{ Item = "held_stone_plate", Amount = 1, Weight = 2},
			{ Item = "held_toxic_plate", Amount = 1, Weight = 2},
			{ Item = "held_zap_plate", Amount = 1, Weight = 2},
		}
	},
  {
    Category = "Evolution",
		...
		Guaranteed = {
      {
        { Item = "evo_harmony_scarf", Amount = 1, Weight = 3},
      },
      {
        { Item = "evo_harmony_scarf", Amount = 1, Weight = 3},
      },
      ...
      { Item = "evo_deep_sea_scale", Amount = 1, Weight = 3},
			{ Item = "evo_deep_sea_tooth", Amount = 1, Weight = 3},
			{ Item = "evo_dusk_stone", Amount = 1, Weight = 3},
			{ Item = "evo_electirizer", Amount = 1, Weight = 3},
			{ Item = "evo_fire_stone", Amount = 1, Weight = 3},
      { Item = "evo_kings_rock", Amount = 1, Weight = 3},
      ...
      { Item = "evo_magmarizer", Amount = 1, Weight = 3},
      { Item = "evo_oval_stone", Amount = 1, Weight = 3},
      ...
      { Item = "evo_water_stone", Amount = 1, Weight = 3},
      { Item = "evo_razor_claw", Amount = 1, Weight = 3},
      { Item = "evo_razor_fang", Amount = 1, Weight = 3},
      { Item = "evo_reaper_cloth", Amount = 1, Weight = 3},
      { Item = "evo_sun_stone", Amount = 1, Weight = 3},
    }
	},
	{
		Min = 31,
    ...
    Category = "Recruitment",
      ...
      {
        { Item = "apricorn_glittery", Amount = 1, Weight = 2 },
      },
      {
      ...
      { Item = "apricorn_glittery", Amount = 1, Weight = 2 },
			...
			{ Item = "apricorn_white", Amount = 1, Weight = 2 },
			{ Item = "apricorn_yellow", Amount = 1, Weight = 2 },
			{ Item = "medicine_amber_tear", Amount = 3, Weight = 5 },
			{ Item = "machine_assembly_box", Amount = 1, Weight = 5 },
		},
	}
}