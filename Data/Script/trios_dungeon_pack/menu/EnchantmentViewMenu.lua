...
function EnchantmentViewMenu:initialize(title, enchantment_list, generate_menu_text, update_description_summary,
                                        refuse_action, menu_width, label)
...
function EnchantmentViewMenu:createMenu()
  ...
  self.menu = RogueEssence.Menu.ScriptableMultiPageMenu(self.origin, self.menuWidth, self.title, option_array, 0,
    self.MAX_ELEMENTS, function() _MENU:RemoveMenu() end, function() _MENU:RemoveMenu() end, false)
