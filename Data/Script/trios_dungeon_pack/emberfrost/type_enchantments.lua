...
--   flying = { "gligar", "gliscor", "honchkrow", "murkrow", "scyther", "togekiss", "togetic" },
--   ghost = { "aegislash", "ceruledge", "chandelure", "doublade", "dusclops", "dusknoir", "gengar", "gourgeist", "haunter", "lampent", "misdreavus", "mismagius", "phantump", "polteageist", "pumpkaboo", "sinistea", "trevenant" },
--   grass = { "appletun", "applin", "bellossom", "capsakid", "cottonee", "exeggcute", "exeggutor", "gloom", "gourgeist", "lilligant", "lombre", "ludicolo", "nuzleaf", "pansage", "petilil", "phantump", "pumpkaboo", "roselia", "roserade", "scovillain", "shiftry", "simisage", "sunflora", "sunkern", "trevenant", "victreebel", "weepinbell" },
--   ground = { "gligar", "gliscor", "golem", "graveler", "nidoking", "nidoqueen", "onix", "rhydon", "rhyperior", "steelix", "ursaluna" },
--   ice = { "cetoddle", "cloyster", "crabominable", "frosmoth", "sneasel", "snom" },
--   normal = { "chansey", "cinccino", "delcatty", "eevee", "happiny", "heliolisk", "helioptile", "jigglypuff", "minccino", "porygon", "porygon2", "skitty", "ursaluna", "ursaring", "wigglytuff" },
...
-- -- Checkpoint: none
-- {
--   bug = { "buzzwole", "durant", "escavalier", "genesect", "heracross", "illumise", "leavanny", "pheromosa", "pinsir", "scizor", "shedinja", "shuckle", "slither wing", "spidops", "vikavolt", "vivillon", "volbeat", "wormadam", "yanma", "yanmega" },
--   dark = { "absol", "chi-yu", "darkrai", "guzzlord", "inkay", "kingambit", "malamar", "morpeko", "overqwil", "pangoro", "sableye", "spiritomb", "umbreon", "urshifu", "weavile", "yveltal" },
--   dragon = { "cyclizar", "dialga", "dracovish", "dracozolt", "drampa", "druddigon", "duraludon", "eternatus", "flapple", "giratina", "goodra", "guzzlord", "kommo-o", "kyurem", "latias", "latios", "naganadel", "palkia", "rayquaza", "regidrago", "reshiram", "tatsugiri", "turtonator", "walking wake", "zekrom", "zygarde" },
--   electric = { "arctozolt", "dracozolt", "emolga", "iron hands", "iron thorns", "jolteon", "magnezone", "minun", "morpeko", "pachirisu", "pawmot", "pichu", "pincurchin", "plusle", "raikou", "regieleki", "rotom", "sandy shocks", "tapu koko", "thundurus", "togedemaru", "vikavolt", "xurkitree", "zapdos", "zekrom", "zeraora" },
--   fairy = { "alcremie", "azurill", "carbink", "cleffa", "comfey", "diancie", "enamorus", "flutter mane", "gardevoir", "igglybuff", "iron valiant", "klefki", "magearna", "mawile", "milcery", "mime jr.", "mimikyu", "scream tail", "tapu bulu", "tapu fini", "tapu koko", "tapu lele", "togepi", "xerneas", "zacian" },
--   fighting = { "annihilape", "buzzwole", "clobbopus", "cobalion", "grapploct", "great tusk", "hawlucha", "heracross", "hitmonchan", "hitmonlee", "iron hands", "iron valiant", "keldeo", "kommo-o", "kubfu", "marshadow", "pancham", "pangoro", "passimian", "pawmot", "pheromosa", "poliwrath", "quaquaval", "sirfetch'd", "slither wing", "terrakion", "urshifu", "virizion" },
--   fire = { "blacephalon", "chi-yu", "entei", "flareon", "heatmor", "heatran", "ho-oh", "moltres", "reshiram", "torkoal", "turtonator", "victini", "volcanion" },
--   flying = { "aerodactyl", "articuno", "celesteela", "chatot", "cramorant", "crobat", "delibird", "emolga", "enamorus", "farfetch'd", "hawlucha", "ho-oh", "landorus", "lugia", "mantine", "mantyke", "minior", "moltres", "rayquaza", "sigilyph", "skarmory", "swanna", "swoobat", "thundurus", "tornadus", "tropius", "unfezant", "vivillon", "woobat", "yanma", "yanmega", "yveltal", "zapdos" },
--   ghost = { "annihilape", "basculegion", "blacephalon", "cofagrigus", "dhelmise", "flutter mane", "gholdengo", "giratina", "hoopa", "marshadow", "mimikyu", "rotom", "sableye", "shedinja", "spectrier", "spiritomb" },
--   grass = { "budew", "calyrex", "carnivine", "celebi", "dhelmise", "flapple", "kartana", "leafeon", "leavanny", "maractus", "shaymin", "tangela", "tangrowth", "tapu bulu", "tropius", "tsareena", "vileplume", "virizion", "wormadam" },
--   ground = { "great tusk", "groudon", "landorus", "mamoswine", "quagsire", "sandy shocks", "zygarde" },
--   ice = { "arctozolt", "articuno", "cryogonal", "delibird", "eiscue", "glaceon", "glalie", "iron bundle", "kyurem", "lapras", "mamoswine", "regice", "weavile" },
--   normal = { "aipom", "ambipom", "arceus", "audino", "azurill", "blissey", "buneary", "castform", "chatot", "cyclizar", "ditto", "drampa", "dunsparce", "farfetch'd", "farigiraf", "furfrou", "girafarig", "igglybuff", "indeedee", "kangaskhan", "kecleon", "lickilicky", "lickitung", "lopunny", "meloetta", "miltank", "munchlax", "persian", "porygon-z", "regigigas", "silvally", "smeargle", "snorlax", "spinda", "stantler", "tauros", "type: null", "unfezant", "wyrdeer", "zangoose" },
--   poison = { "budew", "crobat", "eternatus", "naganadel", "nihilego", "overqwil", "poipole", "qwilfish", "seviper", "vileplume" },
--   psychic = { "azelf", "bruxish", "calyrex", "celebi", "chimecho", "chingling", "cresselia", "deoxys", "espeon", "farigiraf", "gardevoir", "girafarig", "hoopa", "indeedee", "inkay", "jirachi", "latias", "latios", "lugia", "lunatone", "malamar", "meloetta", "mesprit", "mew", "mewtwo", "mime jr.", "necrozma", "scream tail", "sigilyph", "slowbro", "solgaleo", "solrock", "swoobat", "tapu lele", "unown", "uxie", "veluza", "victini", "woobat", "wyrdeer" },
--   rock = { "aerodactyl", "bonsly", "carbink", "diancie", "iron thorns", "lunatone", "minior", "nihilego", "nosepass", "probopass", "regirock", "relicanth", "shuckle", "solrock", "stakataka", "stonjourner", "sudowoodo", "terrakion" },
--   steel = { "celesteela", "cobalion", "dialga", "duraludon", "durant", "escavalier", "genesect", "gholdengo", "heatran", "jirachi", "kartana", "kingambit", "klefki", "magearna", "magnezone", "mawile", "orthworm", "probopass", "registeel", "scizor", "skarmory", "solgaleo", "stakataka", "togedemaru" },
--   water = { "basculegion", "basculin", "bruxish", "clamperl", "cramorant", "dracovish", "finizen", "gorebyss", "huntail", "iron bundle", "keldeo", "kyogre", "lapras", "luvdisc", "manaphy", "mantine", "mantyke", "palafin", "palkia", "phione", "poliwrath", "pyukumuku", "quagsire", "quaquaval", "qwilfish", "relicanth", "slowbro", "suicune", "swanna", "tapu fini", "tatsugiri", "vaporeon", "veluza", "volcanion", "walking wake", "wishiwashi" },
-- }
...
local checkpoint3 = {
  ...
  steel = { "aron", "bronzor", "ferroseed", "honedge", "lairon", "metang", "pawniard", "tinkatuff", "varoom" },
  water = { "araquanid", "binacle", "brionne", "clauncher", "corsola", "dewott", "drizzile", "finneon", "frogadier", "goldeen", "gyarados", "horsea", "kabuto", "mareanie", "marshtomp", "omanyte", "palpitoad", "prinplup", "psyduck", "sealeo", "seel", "skrelp", "slowpoke", "spheal", "wailmer", "wartortle" },
...
-- FLYING
Flock = EnchantmentRegistry:Register({
  name = "Flock",
  id = "FLOCK",
  percent = 40,
  turns = 4,
