FINAL_WISH_TABLE_TIER_3 = {
  {
    ...
    Max = 34,
      ...
      {
        { Item = "loot_pearl", Amount = 8, Weight = 60 },
        { Item = "loot_nugget", Amount = 1, Weight = 40 },
      }
    },
    Items = {
      { Item = "money", Amount = 500, Weight = 25 },
      { Item = "money", Amount = 600, Weight = 15 },
      { Item = "money", Amount = 700, Weight = 15 },
      { Item = "money", Amount = 800, Weight = 15 },
      { Item = "loot_pearl", Amount = 4, Weight = 10 },
      { Item = "loot_pearl", Amount = 5, Weight = 10 },
      { Item = "loot_pearl", Amount = 6, Weight = 10 },
      { Item = "loot_nugget", Amount = 1, Weight = 7 },
    },
  },
  {
    Category = "Food",
    ...
    Items = {
      ...
      { Item = "food_banana", Amount = 1, Weight = 13 },
      { Item = "food_banana_big", Amount = 1, Weight = 7 },
      { Item = "food_banana_golden", Amount = 1, Weight = 3 }
    },
  },
  {
    Category = "Utility",
  ...
  },
  {
    ...
    AlwaysSpawn = { 
      ...
      "seed_joy", "gummi_wonder", "gummi_wonder", "gummi_wonder", "gummi_wonder",
      "boost_calcium", "boost_carbos", "boost_hp_up", "boost_iron",
      "boost_nectar", "boost_zinc", "boost_calcium", "machine_recall_box"
    },
		Guaranteed = { 
      { 
	...
	},
  {
    ...
    Category = "Recruitment",
      ...
      },
      {
		...
		Items = {
      { Item = "apricorn_glittery", Amount = 1, Weight = 2 },
			{ Item = "apricorn_big", Amount = 1, Weight = 5 },
			...
			{ Item = "apricorn_white", Amount = 1, Weight = 2 },
			{ Item = "apricorn_yellow", Amount = 1, Weight = 2 },
			{ Item = "medicine_amber_tear", Amount = 2, Weight = 2 },
      { Item = "medicine_amber_tear", Amount = 3, Weight = 3 },
