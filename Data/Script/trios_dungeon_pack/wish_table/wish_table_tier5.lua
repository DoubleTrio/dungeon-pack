FINAL_WISH_TABLE_TIER_5 = {
  {
    ...
    Items = {
      { Item = "money", Amount = 700, Weight = 45 },
      { Item = "money", Amount = 800, Weight = 35 },
      { Item = "money", Amount = 900, Weight = 25 },
      { Item = "money", Amount = 1000, Weight = 15 },
      { Item = "loot_pearl", Amount = 5, Weight = 8 },
      { Item = "loot_pearl", Amount = 6, Weight = 7 },
      { Item = "loot_pearl", Amount = 7, Weight = 6 },
      { Item = "loot_pearl", Amount = 8, Weight = 5 },
      { Item = "loot_pearl", Amount = 9, Weight = 4 },
