...
---------------------------------------------------------------]]
function EnchantTools:OnSaveLoad()
...
function EnchantTools:OnAddMenu(menu)
  ...
  local in_dungeon = RogueEssence.GameManager.Instance.CurrentScene == RogueEssence.Dungeon.DungeonScene.Instance
...
---------------------------------------------------------------]]
function EnchantTools:OnUpgrade()
...
function EnchantTools:UnSubscribe(_)
end
